import os
from funcoes import conectar_e_entrar_no_diretorio, fechar_ftp, ler_csvs_da_pasta_ftp
...
ler_csvs_da_pasta_ftp(conectar_e_entrar_no_diretorio(FTP_HOST, FTP_PORT, FTP_USER, FTP_PASS, FTP_DIR),FTP_DIR)